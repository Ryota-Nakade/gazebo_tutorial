// https://qiita.com/srs/items/067df0ffb95923be609a
// オムニホイールロボットのシミュレーションをRVizでやるノード
...
void robot_pose_publish(geometry_msgs::Pose2D pose) {
    ...
    br.sendTransform(tf::StampedTransform(transform, ros::Time::now(), "base_link", "body1"));
}
